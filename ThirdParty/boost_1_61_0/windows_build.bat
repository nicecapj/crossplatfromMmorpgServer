...
b2 --prefix=.\stage\lib64 --toolset=msvc-14.0  runtime-link=static --architecture=x86 address-model=64

REM "build all - MD/MDd(64bit DLL)"
b2 --prefix=.\stage\lib64 --toolset=msvc-14.0  runtime-link=shared --architecture=x86 address-model=64